...
export function Footer() {
  ...
  return (
    <footer
      ...
      style={{ background: a.bgColor, borderTop: `1px solid ${a.accentColor}33` }}
    >
      <div className="mfz-container">
        <div className="grid md:grid-cols-12 gap-10 md:gap-8 mb-12">
          ...
          <div className="md:col-span-5">
            <h3
              ...
              style={{ color: a.textColor, fontFamily: 'Anton, sans-serif', letterSpacing: '-0.02em' }}
            >
              MFZ
            </h3>
            <p
            ...
            <div className="flex gap-3 mt-6">
              <a
                ...
                style={{ background: 'rgba(255,255,255,0.08)', color: a.textColor, border: `1px solid ${a.accentColor}22` }}
              >
                <Instagram size={18} />
              </a>
              <a
          ...
          <div className="md:col-span-4">
            ...
            <ul className="space-y-3 text-sm" style={{ color: a.textColor, opacity: 0.65 }}>
              <li className="flex items-start gap-2">
                <MapPin size={14} className="flex-shrink-0 mt-0.5" style={{ color: a.accentColor }} />
                Peshawar, Pakistan
              </li>
              <li>
                <a
        ...
        >
          <p className="text-xs" style={{ color: a.textColor, opacity: 0.4 }}>
